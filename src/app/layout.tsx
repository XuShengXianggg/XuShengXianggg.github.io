      ...
      <body className={inter.className}>
        <div className="header">
          <ul>
            ...
            <li><Link key={"blog"} href={"/contact"} className="link-style">Blog</Link></li>
          </ul>
        </div>
        ...
        <div className="sidebar">
          <img src="https://multimodality.group/author/%E5%BE%90%E5%9C%A3%E7%BF%94/avatar_hud4756c5e94d1f77c26ea6b1a1ae1d141_108977_270x270_fill_q75_lanczos_center.jpg" 
              ...
              className="avatar"/>
              <h3>Shengxiang Xu</h3>
              <p>Undergraduate students from HHU</p>
              <i id="location" className="bi bi-geo-alt-fill"> Nanjin Jiangsu</i>
              <Link key={"email"} href={"mailto:<EMAIL>"} className="link-style">
                <i className="bi bi-envelope-fill"> Email</i>
              </Link>
              <Link key={"scholar"} href={"https://scholar.google.com.hk/citations?user=L-uWIQUAAAAJ&hl=zh-CN&oi=sra"} className="link-style">
                <i className="bi bi-book"> Google Scholar</i>
              </Link>
              <Link key={"github"} href={"https://github.com/XuShengXianggg"} className="link-style">
